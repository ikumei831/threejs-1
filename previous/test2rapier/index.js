import { initRenderer, initGameScene, animateGame,animateMenu, initMenuScene,initTestScene,initGame2Scene} from './scene.js';
...
async function bootstrap() {
    try {
        ...
        startButton?.addEventListener('click', () => {if (currentState === STATE.MENU) enterLoading(STATE.GAME1)});

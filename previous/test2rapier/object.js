...
export function createCube(scene,world, position = { x: 0, y: 1, z: 0 }, size={w:1,h:1,d:1}, mass=10 ,material = { friction: 0.5, restitution: 0.2 }, materialKey = 'white',type='cube',setSensor=false, rotation = { x: 0, y: 0, z: 0 },scale={x:1,y:1,z:1}) {
    ...
    scene.add(mesh);
    addMeshToPhysics(world,mesh, mass,material,setSensor); 
    return mesh;
}

export function createBall(scene,world, position = { x: 0, y: 5, z: 0 }, radius = 0.5, mass= 10, material = { friction: 0.5, restitution: 0.2 }, materialKey = 'red',type='ball',setSensor=false, rotation = { x: 0, y: 0, z: 0 },scale={x:1,y:1,z:1}) {
...
export function createCylinder(scene,world, position = { x: 0, y: 2, z: 0 }, params = { r: 1, h: 2, seg: 32 }, mass= 10,material = { friction: 0.5, restitution: 0.2 },materialKey = 'white',type='cylinder',setSensor=false, rotation = { x: 0, y: 0, z: 0 },scale={x:1,y:1,z:1}) {
    const geometry = new THREE.CylinderGeometry(params.r, params.r, params.h, params.seg);
    const mesh = new THREE.Mesh(geometry, materials[materialKey] || materials.white);
    mesh.position.set(position.x, position.y, position.z);
    mesh.rotation.set(rotation.x, rotation.y, rotation.z);
    mesh.scale.set(scale.x,scale.y,scale.z);
...
export function createCustomShape(scene,world, vertices,indices, position = { x: 0, y: 0, z: 0 }, mass,material = { friction: 0.5, restitution: 0.2 },materialKey = 'red', type='costum',setSensor=false,rotation = { x: 0, y: 0, z: 0 },scale={x:1,y:1,z:1}) {

...
export function createCube(scene, position = { x: 0, y: 1, z: 0 }, size={w:1,h:1,d:1}, mass=10 ,material = { friction: 0.5, restitution: 0.2 }, materialKey = 'white', rotation = { x: 0, y: 0, z: 0 }) {
    ...
    scene.add(mesh);
    addMeshToPhysics(mesh, mass,material); 
    return mesh;
}

export function createBall(scene, position = { x: 0, y: 5, z: 0 }, radius = 0.5, mass= 10, material = { friction: 0.5, restitution: 0.2 }, materialKey = 'red', rotation = { x: 0, y: 0, z: 0 }) {
...
export function createCylinder(scene, position = { x: 0, y: 2, z: 0 }, params = { rTop: 1, rBottom: 1, h: 2, seg: 32 }, mass= 10,material = { friction: 0.5, restitution: 0.2 },materialKey = 'white', rotation = { x: 0, y: 0, z: 0 }) {

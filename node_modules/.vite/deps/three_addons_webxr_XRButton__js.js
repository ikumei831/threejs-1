//#region node_modules/three/examples/jsm/webxr/XRButton.js
/**
		...
		function showStartXR(mode) {
			...
			button.onclick = function() {
				if (currentSession === null) navigator.xr.requestSession(mode, sessionOptions).then(onSessionStarted);
					...
					currentSession.end();
					if (navigator.xr.offerSession !== void 0) navigator.xr.offerSession(mode, sessionOptions).then(onSessionStarted).catch((err) => {
						console.warn(err);
					});
				}
			};

...
import { Fn, add, cos, nodeObject, screenSize, sin, uniform, uv, vec2, vec3, vec4 } from "./three_tsl.js";
	...
	*/
	setup() {
		...
		return Fn(() => {
			...
			return vec4(vec3(add(color.r, color.g, color.b).div(3).mul(10).sub(5).add(pattern())), color.a);
		})();
	}
};
/**

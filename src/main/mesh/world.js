...
export function addMeshToPhysics(world, mesh, mass = 10, material = { friction: 0.5, restitution: 0.2 },custumshape=0,customsize) {
    ...
    else if(custumshape==1){
        colDesc = RAPIER.ColliderDesc.ball(0.25);
        
    }
    else if(custumshape==2){
        colDesc = RAPIER.ColliderDesc.ball(0.12);
    ...
    //if(custumshape==1)console.log(body.translation());

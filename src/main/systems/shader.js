...
export function initShaderUI(ambientLight, directionalLight, pointLight, targetMeshes = []) {
    ...
    // fMaterial.addBinding(globalShaderSettings, 'floorAoIntensity', { 
    //     min: 0, 
    //     max: 3, 
    //     step: 0.05, 
    //     label: '地板 AO 強度' 
            ...
            if (child.isMesh && child.material) {
                if (Array.isArray(child.material)) {
                    child.material.forEach(mat => {
                        ...
                        if (mat.aoMap) {
                            mat.aoMapIntensity = globalShaderSettings.floorAoIntensity;
                        }
                    });
                } else {
                    ...
                    if (child.material.aoMap) {
                        child.material.aoMapIntensity = globalShaderSettings.floorAoIntensity;
                    }
                }
            }
        });
